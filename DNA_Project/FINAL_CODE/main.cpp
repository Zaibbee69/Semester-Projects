...
int main() {
    ...
    while (true) {
        ...
        cout << endl << endl;
        cout << GREEN << BOLD << "1. " << RESET << "DNA Relation Detection\n";
        cout << GREEN << BOLD << "2. " << RESET << "Mutation Detection\n";
        cout << GREEN << BOLD << "3. " << RESET << "Ancestral Gene Detection\n";
        cout << RED   << BOLD << "4. " << RESET << "Exit\n";
